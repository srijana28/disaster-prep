...
try:
    ...
    local_logger.warning(f"Could not load Google Cloud credentials: {e}. Falling back to standard logging.")
...
app.title = "disaster-prep"
app.description = "API for interacting with the Agent disaster-prep"
...
def collect_feedback(feedback: Feedback) -> dict[str, str]:
    ...
    if hasattr(logger, "log_struct"):
        ...
        local_logger.info(f"Feedback collected: {feedback.model_dump()}")
